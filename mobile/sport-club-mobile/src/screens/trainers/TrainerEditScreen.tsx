...
type TrainerEditRouteProp = RouteProp<TrainersStackParamList, 'TrainerEdit'>;

export default function TrainerEditScreen() {
  const route = useRoute<TrainerEditRouteProp>();
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Başarılı', 'Antrenör bilgileri güncellendi.', [
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Antrenör Düzenle</Text>
