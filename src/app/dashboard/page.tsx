  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-400 mt-2">Spor klübü yönetim paneline hoş geldiniz</p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-3 bg-gray-700/50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-200">Yeni üye kaydı: Ahmet Yılmaz</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-700/50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-200">Antrenman planı güncellendi</p>
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-700/50 rounded-lg">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-200">Ödeme alındı: ₺2,500</p>
        ...
        <div className="bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-sm border border-gray-700">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4 py-2">
              <h3 className="font-medium text-gray-200">Yüzme Antrenmanı</h3>
              <p className="text-sm text-gray-400">Bugün, 15:00 - 17:00</p>
              <p className="text-xs text-gray-500 mt-1">12 katılımcı</p>
            </div>
            <div className="border-l-4 border-green-500 pl-4 py-2">
              <h3 className="font-medium text-gray-200">Basketbol Turnuvası</h3>
              <p className="text-sm text-gray-400">Yarın, 10:00</p>
              <p className="text-xs text-gray-500 mt-1">8 takım</p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4 py-2">
              <h3 className="font-medium text-gray-200">Fitness Değerlendirme</h3>
              <p className="text-sm text-gray-400">Cuma, 14:00 - 18:00</p>
      ...
      <div className="mt-6 bg-gray-800/50 backdrop-blur-md rounded-xl p-6 shadow-sm border border-gray-700">
        <div className="flex items-center justify-between mb-6">
        ...
        <div className="h-64 flex items-center justify-center bg-gray-700/50 rounded-lg">
          <p className="text-gray-400">Grafik alanı - Yakında eklenecek</p>
        </div>
      </div>
    </div>
  );
